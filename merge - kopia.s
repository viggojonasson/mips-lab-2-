...
copyArray:
	...
	sll $t6, $t2, 2			# Address margin för nuvarande element
	add $t7, $a0, $t6		# Address + address margin för att få det element vi vill ha
	lw  $t8, 0($t7)			# $t8 = a[i];
	
    	add $t9, $t5, $t6         	# Destination address = base + (i * 4)
  	sw  $t8, 0($t9)           	# Lägg värdet i $t8 i destinationsaddressen
